...
// Lowercase glyphs are separate from the old uppercase-only shell font.
static const uint8_t font_glyph_lower_a[8] = {0x00, 0x00, 0x3c, 0x02, 0x3e, 0x42, 0x3e, 0x00};
static const uint8_t font_glyph_lower_b[8] = {0x40, 0x40, 0x5c, 0x62, 0x42, 0x62, 0x5c, 0x00};
static const uint8_t font_glyph_lower_c[8] = {0x00, 0x00, 0x3c, 0x42, 0x40, 0x42, 0x3c, 0x00};
static const uint8_t font_glyph_lower_d[8] = {0x02, 0x02, 0x3a, 0x46, 0x42, 0x46, 0x3a, 0x00};
static const uint8_t font_glyph_lower_e[8] = {0x00, 0x00, 0x3c, 0x42, 0x7e, 0x40, 0x3c, 0x00};
static const uint8_t font_glyph_lower_f[8] = {0x0c, 0x10, 0x3c, 0x10, 0x10, 0x10, 0x10, 0x00};
static const uint8_t font_glyph_lower_g[8] = {0x00, 0x00, 0x3e, 0x42, 0x3e, 0x02, 0x3c, 0x00};
static const uint8_t font_glyph_lower_h[8] = {0x40, 0x40, 0x5c, 0x62, 0x42, 0x42, 0x42, 0x00};
static const uint8_t font_glyph_lower_i[8] = {0x10, 0x00, 0x30, 0x10, 0x10, 0x10, 0x38, 0x00};
static const uint8_t font_glyph_lower_j[8] = {0x04, 0x00, 0x0c, 0x04, 0x04, 0x44, 0x44, 0x38};
static const uint8_t font_glyph_lower_k[8] = {0x40, 0x40, 0x44, 0x48, 0x70, 0x48, 0x44, 0x00};
static const uint8_t font_glyph_lower_l[8] = {0x30, 0x10, 0x10, 0x10, 0x10, 0x10, 0x38, 0x00};
static const uint8_t font_glyph_lower_m[8] = {0x00, 0x00, 0x6c, 0x92, 0x92, 0x92, 0x92, 0x00};
static const uint8_t font_glyph_lower_n[8] = {0x00, 0x00, 0x5c, 0x62, 0x42, 0x42, 0x42, 0x00};
static const uint8_t font_glyph_lower_o[8] = {0x00, 0x00, 0x3c, 0x42, 0x42, 0x42, 0x3c, 0x00};
static const uint8_t font_glyph_lower_p[8] = {0x00, 0x00, 0x5c, 0x62, 0x5c, 0x40, 0x40, 0x00};
static const uint8_t font_glyph_lower_q[8] = {0x00, 0x00, 0x3a, 0x46, 0x3a, 0x02, 0x02, 0x00};
static const uint8_t font_glyph_lower_r[8] = {0x00, 0x00, 0x5c, 0x62, 0x40, 0x40, 0x40, 0x00};
static const uint8_t font_glyph_lower_s[8] = {0x00, 0x00, 0x3e, 0x40, 0x3c, 0x02, 0x7c, 0x00};
static const uint8_t font_glyph_lower_t[8] = {0x10, 0x10, 0x7c, 0x10, 0x10, 0x12, 0x0c, 0x00};
static const uint8_t font_glyph_lower_u[8] = {0x00, 0x00, 0x42, 0x42, 0x42, 0x46, 0x3a, 0x00};
static const uint8_t font_glyph_lower_v[8] = {0x00, 0x00, 0x42, 0x42, 0x24, 0x24, 0x18, 0x00};
static const uint8_t font_glyph_lower_w[8] = {0x00, 0x00, 0x82, 0x92, 0x92, 0xaa, 0x44, 0x00};
static const uint8_t font_glyph_lower_x[8] = {0x00, 0x00, 0x42, 0x24, 0x18, 0x24, 0x42, 0x00};
static const uint8_t font_glyph_lower_y[8] = {0x00, 0x00, 0x42, 0x42, 0x3e, 0x02, 0x3c, 0x00};
static const uint8_t font_glyph_lower_z[8] = {0x00, 0x00, 0x7e, 0x04, 0x18, 0x20, 0x7e, 0x00};
...
const uint8_t *font_get_glyph(uint32_t character) {
    ...
    if (character == 'Z')
        return font_glyph_z;
    if (character == 'a')
        return font_glyph_lower_a;
    if (character == 'b')
        return font_glyph_lower_b;
    if (character == 'c')
        return font_glyph_lower_c;
    if (character == 'd')
        return font_glyph_lower_d;
    if (character == 'e')
        return font_glyph_lower_e;
    if (character == 'f')
        return font_glyph_lower_f;
    if (character == 'g')
        return font_glyph_lower_g;
    if (character == 'h')
        return font_glyph_lower_h;
    if (character == 'i')
        return font_glyph_lower_i;
    if (character == 'j')
        return font_glyph_lower_j;
    if (character == 'k')
        return font_glyph_lower_k;
    if (character == 'l')
        return font_glyph_lower_l;
    if (character == 'm')
        return font_glyph_lower_m;
    if (character == 'n')
        return font_glyph_lower_n;
    if (character == 'o')
        return font_glyph_lower_o;
    if (character == 'p')
        return font_glyph_lower_p;
    if (character == 'q')
        return font_glyph_lower_q;
    if (character == 'r')
        return font_glyph_lower_r;
    if (character == 's')
        return font_glyph_lower_s;
    if (character == 't')
        return font_glyph_lower_t;
    if (character == 'u')
        return font_glyph_lower_u;
    if (character == 'v')
        return font_glyph_lower_v;
    if (character == 'w')
        return font_glyph_lower_w;
    if (character == 'x')
        return font_glyph_lower_x;
    if (character == 'y')
        return font_glyph_lower_y;
    if (character == 'z')
        return font_glyph_lower_z;
    if (character == '0')
